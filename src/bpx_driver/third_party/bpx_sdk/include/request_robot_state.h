...
public:
    ...
    bool getImuRpy(float rpy[3]) const;
    bool getImuQuat(float quat[4]) const;
    ...
    std::optional<std::array<float, 3>> getImuRpyArray() const;
    std::optional<std::array<float, 4>> getImuQuatArray() const;
